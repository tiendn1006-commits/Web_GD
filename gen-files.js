...
export const Testimonials = () => {
  ...
  useEffect(() => { loadFallbackData(); setLoading(false); }, []);

  const loadFallbackData = () => setTestimonials([
    { id: 1, name: 'Nguyen Van A', role: 'Frontend Developer', content: 'Khoa hoc rat bo ich, giang vien nhiet tinh va tan tam. Toi da hoc duoc rat nhieu kien thuc thuc te.', rating: 5, avatar: 'https://ui-avatars.com/api/?name=Nguyen+Van+A&background=14B8A6&color=fff' },
    { id: 2, name: 'Tran Thi B', role: 'UI/UX Designer', content: 'Chuong trinh hoc duoc thiet ke rat khoa hoc, de hieu. Moi truong hoc tap chuyen nghiep.', rating: 5, avatar: 'https://ui-avatars.com/api/?name=Tran+Thi+B&background=D4AF37&color=fff' },
    { id: 3, name: 'Le Van C', role: 'Full-stack Developer', content: 'Sau khoa hoc toi da tu tin hon rat nhieu trong cong viec. Cam on doi ngu giang vien!', rating: 5, avatar: 'https://ui-avatars.com/api/?name=Le+Van+C&background=1E3A5F&color=fff' }
  ]);
...
const schema = z.object({
  ...
  phone: z.string().min(1, 'Vui long nhap SDT').regex(/^[0-9]{10}$/, 'SDT phai co 10
